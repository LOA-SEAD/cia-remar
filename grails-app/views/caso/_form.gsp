    ...
    <ul class="collapsible" data-collapsible="accordion">
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="input-field col s12 required">
                        <textarea id="pergunta1" class="materialize-textarea" name="pergunta1" data-length="50" value="${casoInstance?.pergunta1}"></textarea>
        ...
        <li>
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="input-field col s12 required">
                        <textarea id="pergunta2" class="materialize-textarea" name="pergunta2" data-length="50" value="${casoInstance?.pergunta2}"></textarea>
        ...
        <li>
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="input-field col s12 required">
                        <textarea id="pergunta3" class="materialize-textarea" name="pergunta3" data-length="50" value="${casoInstance?.pergunta3}"></textarea>
        ...
        <li>
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="input-field col s12 required">
                        <textarea id="pergunta4" class="materialize-textarea" name="pergunta4" data-length="50" value="${casoInstance?.pergunta4}"></textarea>
        ...
        <li>
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="input-field col s12 required">
                        <textarea id="pergunta5" class="materialize-textarea" name="pergunta5" data-length="50" value="${casoInstance?.pergunta5}"></textarea>
        ...
        <li>
            ...
            <div class="collapsible-body">
                <div class="row">
                    <div class="input-field col s12 required">
                        <textarea id="pergunta6" class="materialize-textarea" name="pergunta6" data-length="50" value="${casoInstance?.pergunta6}"></textarea>
